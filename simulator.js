function runSim(gearTable, baseLine, makeBaseLine) {
  ...
  var crit = Number(document.getElementById("spellCrit").value) + 1*document.getElementById("enchantPowerScourge").checked + 0;
  ...
  setCookie("regularArcaneElixir", document.getElementById("regularArcaneElixir").checked);
